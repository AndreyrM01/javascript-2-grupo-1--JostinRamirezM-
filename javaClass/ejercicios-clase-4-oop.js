...
const mariana = new EstudianteConstructor('Mariana', 'Salazar', '2000-10-12', 'web-0001', true, 'Diseño Web', ['Interfases', 'Diseño y Color']);
nicole.cursoCursado('curso: Interfases', 90);

console.log(mariana);

const pedro = new EstudianteConstructor('Pedro', 'Rodriguez', '1989-04-12', 'web-0002', true, 'Diseño Web', ['Diseño y Color']);
peter.cursoCursado('curso: Diseño y Color', 65);
